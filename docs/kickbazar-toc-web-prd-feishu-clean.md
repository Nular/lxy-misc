...
| 2026/09/23 | v1.2.3 | 廖炫尧 | §4.4 改为首页（Banner+一级分类+特色馆+Recommended）；§4.7.9–12 不动 |
...
4. Recommended 召回/展示规则见 **§4.7.9–4.7.12**（与 Sort By recommend 枚举区分）。
...
**§4.7.9–4.7.12 推荐组件：保持原稿不动。** 首页 Recommended 区块仅描述嵌入关系，全局规则仍以 §4.7.9–4.7.12 为准。
...
| C 页面对照 | #6 首页→**§4.4**；#18 推荐→**§4.7.9–4.7.12**（保持不变）；#17 标本期不做 |
